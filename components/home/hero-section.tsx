...
import { StripeGlobe } from "@/components/home/stripe-globe";
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center -mt-8 pt-12 transition-colors duration-300 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          style={{ y: blobY2 }}
          className="absolute bottom-1/4 right-1/4 w-[28rem] h-[28rem] bg-purple-500/15 rounded-full blur-[140px] animate-pulse delay-1000"
        />
        ...
        <div className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.05] drop-shadow-lg">
              <span className="text-foreground dark:text-white transition-colors">
                Jaygraphy:
              </span>
              <br />
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Engineering student by day, photographer by choice. From the
              Grotto’s blue caves to late-night city light trails—every set is
              sequenced, color-managed, and treated like a finished series.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-3 px-4 py-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur text-sm text-muted-foreground/80">
                ...
                <div>
                  ...
                  <p className="text-xs">
                    Intentional grading, clean delivery, zero clutter.
                  </p>
                </div>
              </div>
            </div>
