...
import { getPhotoById, savePhoto } from "@/lib/supabase/photo-storage";
...
export async function PATCH(
  ...
  const updatePayload: Partial<SupabasePhoto> = {
    id: photo.id,
  ...
  await savePhoto(updatePayload);
  const refreshed = await getPhotoById(photo.id);
